...
// in wellbeing_mapper/test/location_sharing_integration_test.dart.
...
import 'package:wellbeing_mapper/services/app_mode_service.dart' as _i9;
...
/// A class which mocks [AppModeService].
///
/// See the documentation for Mockito's code generation for more information.
class MockAppModeService extends _i1.Mock implements _i9.AppModeService {
  MockAppModeService() {
    _i1.throwOnMissingStub(this);
  }
}
